...
# ✅ Recommendation: C-Pay should audit C-Rewards engagement among its 160 high-risk customers specifically — how many have an active rewards wallet, how many have ever redeemed points, and how many are unaware of the programme entirely. A targeted re-engagement campaign for at-risk urban customers that leads with C-Rewards — "You have X points waiting — here's what you can do with them" — would cost significantly less than acquiring replacement customers and could reactivate a meaningful portion of dormant accounts. The 51 at-risk Maseru customers alone represent a concentrated, high-value target for a pilot campaign.
